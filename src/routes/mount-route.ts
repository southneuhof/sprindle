...
export type MountedRoute = ModelRouteMount<string, DefinedModel> | HonoRouteMount
...
export function mountRoute(config: { path: string; model?: DefinedModel; route?: Hono }): MountedRoute {
